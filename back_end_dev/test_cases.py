...
with open('back_end_dev/json_5.json', 'r') as f:
                    ...
                    for park in c['Responses']['Parks'].keys():
                        ...
                        for insured in c['Responses']['Insured'].keys():
                            ...
                            if ("Fayetteville" in c['Name']) and \
                                ...
                                # print(responses_vote**2, responses_vote*responses_vote,
                                #       responses_fruit**2, responses_fruit*responses_fruit,
                                #       responses_education**2, responses_education*responses_education,
                                #       responses_insured,
                                #       responses_park)
                                # print(min_max)
                                # print(dist)
...
df_all_similarities.to_csv('back_end_dev/similarities_all_combinations.csv', index=False)
df_tests.to_csv('back_end_dev/similarities_100_combinations.csv', index=False)
